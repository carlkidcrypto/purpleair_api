#!/usr/bin/env python3
"""Analyze Python source coverage gaps for the purpleair_api project.

This script statically inspects the Python source files in ``purpleair_api/``
...
Usage:
    ...
    python3 .github/scripts/analyze_python_coverage_gaps.py --src purpleair_api --tests tests
"""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Analyze Python coverage gaps for purpleair_api."
    )
    parser.add_argument(
        "--src",
        default="purpleair_api",
        help="Path to Python source directory (default: 'purpleair_api').",
    )
    parser.add_argument(
        "--tests",
        default="tests",
