"""Unit tests for .github/scripts/audit_docs.py in purpleair_api."""
...
def test_audit_file_clean():
    clean_text = """
    \"\"\"This is a clean docstring using PurpleAirAPI.\"\"\"
    def receive_data():
        pass
    """
...
def test_audit_file_with_issues_and_fix():
    ...
    # Use PurpleairReadAPI to fetch sensors.
    """
    ...
    try:
        ...
        assert any("PurpleairReadAPI" in d for d in descriptions)
        ...
        assert "PurpleAirReadAPI" in fixed_content
