...
.. image:: https://img.shields.io/github/downloads/carlkidcrypto/purpleair_api/v1.4.1/total.svg?style=flat-square
   :target: https://github.com/carlkidcrypto/purpleair_api/releases/tag/v1.4.1
...
Matter Device Converter (Matter 1.6)
------------------------------------
Map PurpleAir sensor data to **Matter** device type structures for use with
Matter-compatible ecosystems (Apple Home, Google Home, Alexa, SmartThings,
Home Assistant Matter integration).

Supports Matter 1.6 Air Quality Sensor (Device Type 0x002D), Temperature Sensor,
and Environmental Sensor device types with full EPA AQI calculation.
...
- Matter 1.6 Core Specification (CSA, 2024) — https://csa-iot.org/developer-resource/specifications/
