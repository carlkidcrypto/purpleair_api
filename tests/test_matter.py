...
Unit tests for purpleair_api.matter — Matter Device Converter.
"""
...
class PurpleAirMatterConverterAirQualitySensorTest(unittest.TestCase):
    ...
    def test_matter_version_1_6(self):
        self.assertEqual(self.result["device_type"]["matter_version"], "1.6")
    ...
    def test_missing_fields_defaults_to_zero(self):
        ...
        self.assertEqual(attrs["pm1Density"], 0)
